...
/**
 * @ast node
 * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/lang.ast:26
...
public class IdUseExpr extends Expr implements Cloneable {
   ...
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/Interp.jrag:87
   */
...
protected boolean isCircular_visited = false;
   ...
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/CircularDefinitions.jrag:6
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="CircularDefinitions", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/CircularDefinitions.jrag:6")
...
protected boolean type_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/TypeAnalysis.jrag:19
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/TypeAnalysis.jrag:19")
  public Type type() {
    if (type_visited) {
  ...
  @ASTNodeAnnotation.Source(aspect="CircularDefinitions", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/CircularDefinitions.jrag:9")
...
protected java.util.Set inExprOf_IdDecl_visited;
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/Errors.jrag:40
    if (isCircular()) {
      {
    ...
    // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/Errors.jrag:52
  ...
  protected void collect_contributors_IdDecl_idUses(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/UnusedVars.jrag:12
    if (true) {
      {
        IdDecl target = (IdDecl) (getIdUse().decl());
        java.util.Set<ASTNode> contributors = _map.get(target);
        if (contributors == null) {
          contributors = new java.util.LinkedHashSet<ASTNode>();
          _map.put((ASTNode) target, contributors);
    ...
    super.collect_contributors_IdDecl_idUses(_root, _map);
  }
  ...
  protected void contributeTo_IdDecl_idUses(Set<IdUseExpr> collection) {
    super.contributeTo_IdDecl_idUses(collection);
    if (true) {
      collection.add(this);
    }
  }
