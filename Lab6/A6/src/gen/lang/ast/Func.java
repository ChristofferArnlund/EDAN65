...
/**
 * @ast node
 * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/lang.ast:2
...
public class Func extends ASTNode<ASTNode> implements Cloneable, Comparable<Func> {
   ...
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/FuncComparable.jrag:3
   */
  ...
  /**
   * @aspect Interp
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/Interp.jrag:36
   */
...
protected ASTNode$State.Cycle reachable_cycle = null;
  ...
  @ASTNodeAnnotation.Source(aspect="Reachability", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/Reachability.jrag:4")
...
protected boolean isUnknownFunc_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownFunc
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/UnknownFunc.jrag:9
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UnknownFunc", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/UnknownFunc.jrag:9")
...
protected boolean numLocals_visited = false;
  ...
  public int numLocals() {
    ...
    int numLocals_value = lastNode().localIndex();
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/NameAnalysis.jrag:64
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/NameAnalysis.jrag:64")
...
protected java.util.Set lookup_String_visited;
  /**
   * @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/CircularDefinitions.jrag:9
   * @apilevel internal
   */
  ...
  public boolean Define_isFunction(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getFuncNameNoTransform()) {
      // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/IdUseTypeAnalysis.jrag:5
      return true;
    }
    else {
  ...
  public boolean Define_isVariable(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getFuncNameNoTransform()) {
      // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/IdUseTypeAnalysis.jrag:6
      return false;
    }
    else {
  ...
  public IdDecl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getFuncNameNoTransform()) {
      // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/NameAnalysis.jrag:61
      return lookup(name);
    }
    else {
      int childIndex = this.getIndexOfChild(_callerNode);
  ...
  public boolean Define_isFunctionParam(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getFuncParamsListNoTransform()) {
      ...
      return getParent().Define_isFunctionParam(this, _callerNode);
    }
  }
  ...
  public String Define_uniqueNamePrefix(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getStmtBlockNoTransform()) {
      // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/uniqueIdDeclName.jrag:20
      return getFuncName().getID() + "_";
    }
    else {
      int childIndex = this.getIndexOfChild(_callerNode);
      {
...
protected boolean Func_functionCalls_visited = false;
  ...
  @ASTNodeAnnotation.Source(aspect="callGraphAnalysis", declaredAt="/home/marcus/git/EDAN65/Lab6/A6/src/jastadd/callGraphAnalysis.jrag:5")
  ...
  protected void collect_contributors_Program_deadFuncs(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/marcus/git/EDAN65/Lab6/A6/src/jastadd/deadFuncs.jrag:11
