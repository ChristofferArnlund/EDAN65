...
public class TestParamAnalysis extends AbstractParameterizedTest {
	/**
	 * Directory where test files live
	 */
	private static final String TEST_DIR = "testfiles/paramanalysis";

	/**
	 * Construct a new JastAdd test
	 * @param filename filename of test input file
	 */
	public TestParamAnalysis(String filename) {
