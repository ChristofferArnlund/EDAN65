...
/**
 * @ast node
 * @declaredat /h/d8/a/dat13mro/git/EDAN65/A2-MinimalAST/src/jastadd/lang.ast:12
 * @production FuncCall : {@link Expr} ::= <span class="component">&lt;ID:String&gt;</span> <span class="component">{@link Expr}*</span>;
...
public class FuncCall extends Expr implements Cloneable {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_ID == ((FuncCall) node).tokenString_ID);    
  }
  /**
